// @ts-nocheck
import { chakra, forwardRef, HTMLChakraProps, ThemingProps, useStyles } from '@chakra-ui/system';
...
export const Step = forwardRef<StepProps, 'li'>((props, ref: React.Ref<any>) => {
    const {
        children,
        description,
        icon,
    ...
    const { isVertical, isError, isLoading, isLabelVertical, checkIcon, onClickStep, clickable, setWidths, stepCount } =
        useStepsContext();
