...
export const StepLabel = ({ isCurrentStep, opacity, label, description }: StepLabelProps) => {
    const { labelContainer, label: labelStyles, description: descriptionStyles } = useStyles();
