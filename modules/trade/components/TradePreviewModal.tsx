...
import { Box, Flex, Heading, Link, ModalHeader, ModalOverlay, Text } from '@chakra-ui/react';
...
export function TradePreviewModal({ isOpen, onClose }: Props) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} size="2xl" initialFocusRef={initialRef}>
            <ModalOverlay />
            <ModalContent backgroundColor="black">
                ...
                <ModalHeader className="bg">
                    ...
                    <Text color="gray.200" fontSize="md">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent orci orci.
                    </Text>
                </ModalHeader>
